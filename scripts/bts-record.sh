...
#
# Usage (Claude calls this before producing any output):
#   bash scripts/bts-record.sh '<json>'
#
# Minimal JSON (all other fields optional):
#   {
#     "level": "prompt|task|micro",
#     "context": "what choice was being made",
#     "options": [
#       {"name": "A", "pros": ["..."], "cons": ["..."], "selected": false, "reason": "..."},
#       {"name": "B", "pros": ["..."], "cons": ["..."], "selected": true,  "reason": "..."}
#     ],
#     "selected": "B",
